...
__all__ = ["register_jobplanningandmanagement_job_cancel_reasons_tools"]


def register_jobplanningandmanagement_job_cancel_reasons_tools(mcp: Any) -> None:
    @mcp.tool()
    async def jpm_job_cancel_reasons_get_list(
        tenant: int,
        ...
        """Get a paginated list of job cancel reasons.

        Mirrors JobCancelReasons_GetList.
        ...
        url = f"{base_url}/jpm/v2/tenant/{tenant}/job-cancel-reasons"
