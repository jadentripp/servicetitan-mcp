...
__all__ = ["register_jobbooking_call_reasons_tools"]


def register_jobbooking_call_reasons_tools(mcp: Any) -> None:
    @mcp.tool()
    async def jobbooking_get_call_reasons(
        tenant: int,
        ...
        """Get a paginated list of call reasons.

        Mirrors CallReasons_Get.
        ...
        url = f"{base_url}/jbce/v2/tenant/{tenant}/call-reasons"
        ...
        if not data:
            return "Unable to fetch call reasons."
